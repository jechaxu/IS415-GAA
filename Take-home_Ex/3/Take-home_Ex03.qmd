...
![](images/clipboard-500690992.png)
...
![Image taken from [Dr. Paula Moraga](https://www.paulamoraga.com/book-geospatial/sec-shiny.html)](images/Screenshot 2024-03-20 at 9.02.23 PM.png){width="551"}
...
tmap functions are used to plot the local Gi\* (i.e. gi_star).
...
map1 <- tm_shape(HCSA_2022) +
  ...
  tm_borders(alpha = 0.5) +
  tm_view(set.zoom.limits = c(6,8)) +
  tm_layout(main.title = "Gi* of crimes",
            main.title.size = 0.8)
