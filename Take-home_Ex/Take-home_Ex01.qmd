...
=======
>>>>>>> 53e89201ffaa61e8309931c5c712a08a5c3f157b
...
### 9.1.3 Displaying 2023 

```{r}
tmap_mode('view')
tm_shape(acled_2023.Q1_sf)+
  tm_dots()
```
...
```{r}
tmap_mode('view')
tm_shape(acled_2023.Q3_sf)+
  tm_dots()
```

```{r}
tmap_mode('view')
tm_shape(acled_2023.Q4_sf)+
  tm_dots()
```

### 9.1.4 Displaying 2024
...
## 9.2 Displaying Spatio-Temporal KDE layers

### 9.2.1 Displaying 2021
...
# 10.0 Describing spatial patterns reveal by KDE and Spatio-temporal KDE maps
>>>>>>> 53e89201ffaa61e8309931c5c712a08a5c3f157b
